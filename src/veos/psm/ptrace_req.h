...
/* from ve_hw_ve1.h and ve_hw_ve3.h */
#define VE_SR_NUM (64)
#define VE_VR_NUM (64)
#define VE_AUR_MVL (256)
...
struct ve_user_regs {
	...
	ve_reg_t SAR;			/*  0x1030 -  0x1037 */
	ve_reg_t PMMR;			/*  0x1038 -  0x103F */
	ve_reg_t PMCR[4];		/*  0x1040 -  0x105F */
	uint8_t pad1[0x1400 - 0x1060];	/*  0x1070 -  0x13FF */
	/* Scalar Registers */
	ve_reg_t SR[VE_SR_NUM];		/*  0x1400 -  0x15FF */
...
struct ve_user_vregs {
        ...
        /* Vector Registers */
        ve_reg_t VR[VE_VR_NUM][VE_AUR_MVL];      /* 0x3E800 - 0x5FFFF */
...
// off_t psm_get_reg_offset(ve_usr_reg_name_t);
