...
/**
* @file task_signal_ve1.h
* @brief VE1-depende part of header for signal handling
*
* @internal
* @author Signal Handling
*/
#ifndef VEOS_VE1_PSM_TASK_SIGNAL_VE1_H
#define VEOS_VE1_PSM_TASK_SIGNAL_VE1_H
#include <libved.h>
#include <ve_hw.h>
/**
...
struct ve1_ucontext {
	...
	struct ve1_ucontext *uc_link;	/*!< Pointer to process context */
	stack_t uc_stack;		/*!< stack used by this context */
	ve1_core_user_reg_t uc_mcontext;/*!< Stores VE process context */
...
struct ve1_sigframe {
	...
	struct ve1_ucontext uc;	/*!< Process context information*/
