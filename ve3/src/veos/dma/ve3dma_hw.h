...
/**
 * @file ve3dma_hw.h
 * @brief Definitions of parameters for VE3 DMA engine
 */
#ifndef VE_VEOS_VE3DMA_HW_H
#define VE_VEOS_VE3DMA_HW_H

/* DMA engine control register */
#define VE_DMA_OFFSET_OF_DMACTL (offsetof(ve3_system_common_reg_nonpre_t, DMACTLP))
...
/* DMA descriptor */
#define VE_DMA_OFFSET_OF_DMADESC(i) (offsetof(ve3_system_common_reg_nonpre_t, DMADESP[(i)]))
/* word 0 */
...
#define VE_DMA_DESC_ADDR_VERAA_NON_PREFETCHABLE (4UL)
#define VE_DMA_DESC_ADDR_VHSAA (2UL)
#define VE_DMA_DESC_ADDR_VERAA_PREFETCHABLE (0UL)
...
#define VE_DMA_DESC_CTL_PCI_RO  (2UL << 45)
#define VE_DMA_DESC_CTL_PCI_IDO (4UL << 45)

#define VE3_DMA_NUM_DESC (128)
